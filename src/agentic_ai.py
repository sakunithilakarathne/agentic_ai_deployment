...
if __name__ == "__main__":
    ...
    print(f"\nProposals: {result.summary['total_proposals']}")
    print(f"  High Priority: {result.summary['high_priority_proposals']}")
    print(f"\nProjected Impact:")
    print(f"  Current: {result.summary['current_score']:.1f}/100")
    print(f"  Projected: {result.summary['projected_score']:.1f}/100")
    print(f"  Improvement: +{result.summary['improvement']:.1f}")
